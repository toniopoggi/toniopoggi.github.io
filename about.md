...
permalink: /about/
section: about
description: About Antonio Poggi, COO at Visokio, and his work across Omniscope, data analytics, AI and air-quality monitoring.
---
...
<section class="section">
  <div class="shell bio-grid">
    ...
    <aside class="bio-aside">
      ...
      <dl>
        <div><dt>Current role</dt><dd>COO, Visokio</dd></div>
        <div><dt>Building</dt><dd>Omniscope</dd></div>
        <div><dt>Based</dt><dd>London, UK</dd></div>
        <div><dt>From</dt><dd>Taranto, Italy</dd></div>
        <div><dt>Languages</dt><dd>Italian · English</dd></div>
        <div><dt>Interested in</dt><dd>Data · Product · Software · AI · Public evidence</dd></div>
      </dl>
    </aside>
  </div>
</section>
